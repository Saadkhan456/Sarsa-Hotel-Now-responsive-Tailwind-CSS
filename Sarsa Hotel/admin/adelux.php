...
<body class="bg-gray-100">
    ...
    <h1 class="text-3xl font-bold text-center mt-4 text-orange-500">Deluxe AC Rooms insert Section</h1>

<div class="flex justify-center mt-4">
    <img src="../img/Rooms/AC Room.jpeg" alt="delux ac" class="h-80 w-80 rounded-3xl shadow-lg">
</div>
